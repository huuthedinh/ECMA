...
const EditProduct = ({ id }) => {
    ...
    <form action="" id="form-update" class="">
      <label for="" class="form-lable">Name</label>
      <input type="text" id="form-name" class="form-control" value="${products.name}">
      <label for="">Mô tả</label>
      <input type="text" id="form-des" class="form-control"value="${products.des}">
      <label for="">price</label>
      <input type="text" id="form-price" class="form-control"value="${products.price}"> 
      <label for="">img</label>
      <input type="file" id="form-img" class="form-control"value="${products.img}"> 
